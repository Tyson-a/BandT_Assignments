...
import MyProjetcs from './MyProjects.tsx';


const meta: Meta<typeof MyProjetcs> = {
  title: 'Components/MyProjetcs', // Update the title to point to AboutMe
  component: MyProjetcs,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
export const Default: StoryObj<typeof MyProjetcs> = {
  args: {
...
export const disabled: StoryObj<typeof MyProjetcs> = {
  args: {
    starsHTML: 3,
    starsCSS: 4,
    disabled: true,
